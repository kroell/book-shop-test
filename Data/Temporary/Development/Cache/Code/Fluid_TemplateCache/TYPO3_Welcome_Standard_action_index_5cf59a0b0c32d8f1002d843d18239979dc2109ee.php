<?php
class FluidCache_TYPO3_Welcome_Standard_action_index_5cf59a0b0c32d8f1002d843d18239979dc2109ee extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en" xmlns:f="urn:flow:fluid">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
<title>Welcome to TYPO3 Flow</title>
';
...
$arguments5 = array();
$arguments5['path'] = 'Styles/Styles.css';
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Uri\ResourceViewHelper
$arguments8 = array();
$arguments8['path'] = 'Libraries/jquery/jquery-1.9.1.min.js';
...
<div class="logo">TYPO3 Flow</div> <h1 class="title">Welcome</h1>
<div class="version">';
...
return '
	<div class="notice">
		...
		<p>You should enable the Development context for your first steps into the world of TYPO3 Flow!<br />
		Check the <a href="http://flow.typo3.org/documentation/guide.html" target="flow">TYPO3 Flow reference</a> and/or
		the <a href="http://flow.typo3.org/documentation/quickstart.html" target="flow">Quickstart tutorial</a> for instructions.</p>
	</div>
';
};
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments23 = array();
$arguments23['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments26 = array();
$arguments26['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments29 = array();
$arguments29['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathWeb', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments36 = array();
$arguments36['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
$output35 .= '</code><br />and run<br /><code>./flow kickstart:package MyCompany.MyPackage</code><br />
											to create a package with a standard controller</p>
									';
return $output35;
};
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments41 = array();
$arguments41['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments44 = array();
$arguments44['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments47 = array();
$arguments47['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathWeb', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments51 = array();
$arguments51['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'flowPathRoot', $renderingContext);
...
$output50 .= '</code><br />and run<br /><code>./flow kickstart:package MyCompany.MyPackage</code><br />
											to create a package with a standard controller</p>
									';
return $output50;
};
...
$output0 .= '
							...
							<li>
								...
								<p>Switch over to the <a href="http://flow.typo3.org/documentation/quickstart.html" target="flow">Quickstart Tutorial</a> to get the a first overview.</p>
							</li>
							<li>
...
return '
										<code>flow.bat package:deactivate TYPO3.Welcome</code>
									';
};
...
return '
										<code>./flow package:deactivate TYPO3.Welcome</code>
									';
};
...
$output0 .= '
				...
				<div class="sidebar">
					...
					<ul>
						<li><a href="http://flow.typo3.org" target="flow">TYPO3 Flow</a></li>
					</ul>
					<h3>Read the documentation</h3>
					<ul>
						<li><a href="http://flow.typo3.org/documentation/" target="flow">Documentation</a></li>
						<li><a href="http://flow.typo3.org/documentation/api/" target="flow">TYPO3 Flow API</a></li>
						<li><a href="http://flow.typo3.org/documentation/codingguidelines.html" target="flow">Coding guidelines</a></li>
						<li><a href="http://forge.typo3.org/projects/flow-distribution-base/issues?query_id=90" target="flow">Known issues</a></li>
					</ul>
					<h3>Get involved</h3>
					<ul>
						<li><a href="http://flow.typo3.org/support.html" target="flow">Discuss your experience</a></li>
						<li><a href="http://forge.typo3.org/projects/flow-distribution-base/issues/new" target="flow">Report a bug</a></li>
					</ul>
				</div>
			</div>
		</div>
		<div class="tab">
			...
			<div class="content">
				<div class="main">
					<div class="spacer">
						<h3 class="first">About TYPO3 Flow</h3>
						<p>TYPO3 Flow is an offspring from the development of the rewrite of <a href="http://typo3.org">TYPO3 CMS</a> and
						can be used independently as an application framework. It is licensed under the terms of the GNU Lesser General
						Public License version 3 or later.</p>
						<h3>Credits</h3>
						<p>Many people have contributed to TYPO3 Flow with ideas, design, testing, money, code and espresso. A big thank you goes to the
						TYPO3 community and the members of the TYPO3 Association who made the development of TYPO3 Flow possible at all.</p>
						<p>The main part of TYPO3 Flow was designed and developed by Robert Lemke. The persistence integration was developed and major
						contributions to TYPO3 Flow were made by Karsten Dambekalns, who co-leads the project. Andreas Förthner designed and developed the
						Security Framework while Bastian Waidelich created the initial implementation of TYPO3 Flow\'s routing mechanism. Sebastian Kurfürst
						and Bastian Waidelich designed and implemented the Fluid templating engine.</p>
						<p>Further code contributions were made by the TYPO3 Flow team and others: Adrian Föder, Alexander Stehlik, Andreas Wolf, Aske Ertmann,
						...
						the design of TYPO3 Flow are AspectJ, NanoContainer, Ruby on Rails, Symfony, QT and surely more.</p>
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments94 = array();
$arguments94['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'package.packageKey', $renderingContext);
...
$output93 .= '</span> <small><span class="package-version">';
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments97 = array();
$arguments97['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'package.packageMetaData.version', $renderingContext);
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Format\HtmlspecialcharsViewHelper
$arguments100 = array();
$arguments100['value'] = \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), 'package.packageMetaData.description', $renderingContext);
